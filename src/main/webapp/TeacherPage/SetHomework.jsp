...
<div id="container">
    ...
    <div class="box2">
        <h2>布置作业页面</h2>
        <form id = "form1" action="/sethomework" method="post" name="sethomework">
            ...
            作业内容：<br/><textarea id="content" name="workcontent" style="width:200px;height:80px;">这里写内容</textarea><br/>
            <input type="button" value="提交作业" onclick="ok()"><br/>
        </form>
        <%
...
<script type="text/javascript" charset="utf-8">
    function ok() {
        ...
        document.all.sethomework.submit();
    }
</script>
